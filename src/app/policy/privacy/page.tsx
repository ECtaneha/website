...
export default function Page() {
  return (
    <div className={styles.privacyPolicyContainer}>
      ...
      <br />
      <h2 className={styles.h2}>個人情報の取り扱いについて</h2>
      ...
      <h2 className={styles.h2}>個人情報の保護に関する法令・規範の遵守について</h2>
      <p>
      ...
      <h2 className={styles.h2}>個人情報の安全管理措置について</h2>
      <p>
      ...
      <h2 className={styles.h2}>継続的な改善について</h2>
      <p>
      ...
      <h2 className={styles.h2}>CookieとWebビーコンの利用</h2>
      <p>
      ...
      <h2 className={styles.h2}>Googleアナリティクスの利用について</h2>
      <p>
